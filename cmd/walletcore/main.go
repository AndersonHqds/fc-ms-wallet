...
import (
	...
	"github.com.br/andersonhqds/fc-ms-wallet/internal/event/handler"
	...
	"github.com.br/andersonhqds/fc-ms-wallet/pkg/kafka"
...
func main() {
	db, err := sql.Open("mysql", fmt.Sprintf("%s:%s@tcp(%s:%s)/%s?charset=utf8&parseTime=True&loc=Local", "root", "root", "mysql",
		"3306", "wallet"))
	if err != nil {
		panic(err)
	}
	...
	eventDispatcher.Register("balance.updated", handler.NewUpdateBalanceKafkaHandler(kafkaProducer))
